...
export class ProductsComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.sub = this.activatedRoute.params.subscribe(params => {
            ...
            if (this.currentUrl.indexOf("products/browsing-history") !== -1) {
                this.getHistoryProducts();
            } else if (this.currentUrl.indexOf("products/today-deals") !== -1) {
                // const catId = this.param.substr(0, this.param.indexOf('cat'));
                this.getTodayDealsProducts();
            } else if (this.param && this.currentUrl.indexOf("products/category") !== -1) {
                // const catId = this.param.substr(0, this.param.indexOf('cat'));
                this.getProductsByCat(this.param);
            } else if (this.param && this.currentUrl.indexOf("products/brand") !== -1) {
                // const brandId = this.param.substr(0, this.param.indexOf('bnd'));
                this.getProductsByBrand(this.param, 1, this.count);
            } else if (this.param && this.currentUrl.indexOf("products/supplier") !== -1) {
                // const brandId = this.param.substr(0, this.param.indexOf('bnd'));
                this.getProductsBySupplier(this.param, 1, this.count);
            } else if (!tempSearch) {
    ...
    public getProductsByBrand(brandId, page, count) {
        this.spinnerService.requestInProcess(true);
        this.appService.getAllProductsByBrand(brandId, page, count).subscribe(data => {
            this.spinnerService.requestInProcess(false);
            // console.log(data.data);
            this.products = data.data.products.data;
            this.itemPerPage = data.data.products.per_page;
            this.totalProducts = data.data.products.total;
    ...
    public getProductsBySupplier(supplierId, page, count) {
        this.spinnerService.requestInProcess(true);
        this.appService.getAllProductsBySupplier(supplierId, page, count).subscribe(data => {
            this.spinnerService.requestInProcess(false);
            // console.log(data.data);
            this.products = data.data.products.data;
            ...
            this.products.forEach(value => {
                value.suppliers.forEach(item => {
                    ...
                    this.productsSupplierArray.push(newProduct);
                });
            });
            // }
            this.products = this.productsSupplierArray;
            // console.log(this.products);
        });
    }
    ...
    public getSuppliers() {
        // this.brands = this.appService.getBrandsNew();
        this.spinnerService.requestInProcess(true);
        this.appService.getSuppliers().subscribe(data => {
    ...
    public getImgSrc(obj) {
        return !obj.image
            ? "assets/images/img_not_available.png"
            : obj.image && obj.image.small.startsWith("http")
                ? obj.image.small
                : this.appService.imgUrl + obj.image.small;
    }
    ...
    public onPageChanged(event) {
        ...
        this.page = event;
        /*this.getAllProducts();*/
        if (this.currentUrl.indexOf("products/supplier") !== -1) {
            this.getProductsBySupplier(this.param, this.page, this.count);
        } else if (this.currentUrl.indexOf("products/brand") !== -1) {
            this.getProductsByBrand(this.param, this.page, this.count);
        } else {
    ...
    public getSupplierProducts(supplier) {
        this.router.navigate(["/products/supplier", supplier.id, supplier.name]);
    }
