...
export class ProductsComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    console.log(de);
    translateService.setDefaultLang(de);
    this.cartSubscription = this.detectChangesService.notifyObservable$.subscribe(
      res => {
        // console.log(res);
        if (res) {
  ...
  public getProductsByBrand(brandId, page, count) {
    this.spinnerService.requestInProcess(true);
    this.appService
      .getAllProductsByBrand(brandId, page, count)
      .subscribe(data => {
        this.spinnerService.requestInProcess(false);
  ...
  public getProductsBySupplier(supplierId, page, count) {
    this.spinnerService.requestInProcess(true);
    this.appService
      .getAllProductsBySupplier(supplierId, page, count)
      .subscribe(data => {
        this.spinnerService.requestInProcess(false);
        // console.log(data.data);
        this.products = data.data.products.data;
