...
export class ProductComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    if (
      !this.appService.Data.browsingHistory.find(
    ...
    localStorage.setItem(
      "browsing_history",
      JSON.stringify(this.appService.Data.browsingHistory)
    );
  ...
  public login() {
    this.router.navigate([
      "/sign-in",
      { pId: this.product.id, pName: this.product.name, sId: this.supplier_id }
    ]);
  }
